...
public class CommandInvoker {
     ...
     */
    public String executeCommand(CollectionHandler collectionHandler, String[] args, BufferedReader reader) {
        return command.execute(collectionHandler, args, reader);
    }
}
